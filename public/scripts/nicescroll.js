...
(function (e) {
    var r = false, w = false, B = 5E3, C = 2E3, D = function () {
        ...
        this.delayed = function (d, c, f, g) {
            ...
            }; else if (!e || !e.tt)b.delaylist[d] = {last: h, tt: 0}, setTimeout(function () {
                c.call()
            }, 0)
        };
        ...
        this.init = function () {
            ...
            if (!b.ispage || !g.cantouch && !g.isieold && !g.isie9mobile) {
                ...
                if (b.ispage)f.css({
                    ...
                    b.body.append(f), b.railh && (k.css({
                    position: "fixed",
                    left: "0px",
                    width: "100%"
                }), k.align ? k.css({bottom: "0px"}) : k.css({top: "0px"}), b.body.append(k)); else {
                    if (b.ishwscroll)b.win.css("position") == "static" && b.css(b.win, {position: "relative"}), d = b.win[0].nodeName == "HTML" ? b.body : b.win, b.zoom && (b.zoom.css({
                        position: "absolute",
                        top: 1,
                        right: 0,
                        ...
                        position: "absolute",
                        top: 0
                    }), f.align ? f.css({right: 0}) : f.css({left: 0}), d.append(f), k && (k.css({
                        position: "absolute",
                        left: 0,
                        bottom: 0
                    }),
                ...
                if (!b.ispage && !b.haswrapper)"WebKitMutationObserver" in window ? (b.observer = new WebKitMutationObserver(function (d) {
                    ...
                    attributes: true,
                    subtree: false
                })) : (b.bind(b.win, g.isie && !g.isie9 ? "propertychange" : "DOMAttrModified", b.onAttributeChange), g.isie9 && b.win[0].attachEvent("onpropertychange", b.onAttributeChange));
        ...
        this.showCursor = function (d, c) {
            ...
            if (b.rail) {
                ...
                b.rail.visibility ? b.cursorh.css({
                    width: b.cursorwidth,
                    left: b.scroll.x + b.rail.width
                }) : b.cursorh.css({width: b.cursorwidth, left: b.scroll.x}), b.cursoractive = true;
